...
$lang = [
    ...
    "property_main_info" => "Main Information",
    ...
    "condo" => "Condo",
    "apartment" => "Apartment",
    "price_per_month" => "Price (Baht/Month)",
    "property_size" => "Size (sq.m.)",
    "bedrooms" => "Bedrooms",
    "bathrooms" => "Bathrooms",
    ...
    "please_select_province" => "-- Select Province --",
    "please_select_district" => "-- Select District --",
    "please_select_sub_district" => "-- Select Sub-district --",
    "google_map_url" => "Google Maps URL",
    "upload_map_image" => "Upload Map Image",
    "upload_new_to_replace" => "Upload a new file to replace the current image",
    "facilities" => "Facilities",
    "please_select_facilities" => "Select facilities",
    "landmarks" => "Nearby Landmarks",
    "please_select_landmark" => "-- Select Landmark --",
    "distance_km" => "Distance (km)",
    "add_landmark" => "Add Landmark",
    "images_and_video" => "Images & Video",
    "bedroom_images" => "Bedroom Images",
    "bathroom_images" => "Bathroom Images",
    "other_images" => "Other Images",
    "plan_images" => "Plan Images",
    "video" => "Promotional Video",
    "current_video" => "Current video (Upload a new file to replace)",
    "status" => "Status",
    "status_available" => "Available",
    "status_full" => "Full",
    "manage_existing_images" => "Manage Existing Images",
    "cover_image" => "Cover",
    "set_as_cover" => "Set as cover image",
    "delete_this_image" => "Delete this image",
    "delete_selected_images" => "Delete Selected Images",
    "confirm_delete_selected_images" => "Are you sure you want to delete all selected images?",
    "confirm_delete_this_image" => "Are you sure you want to delete this image?",
    "confirm_set_as_cover" => "Are you sure you want to set this as the cover image?",
