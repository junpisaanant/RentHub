...
$lang = [
    ...
    "district" => "区",
    "sub_district" => "街道",
    "please_select_province" => "-- 选择府 --",
    "please_select_district" => "-- 选择区 --",
    "please_select_sub_district" => "-- 选择街道 --",
    "google_map_url" => "谷歌地图链接",
    "upload_map_image" => "上传地图图片",
    "upload_new_to_replace" => "上传新文件以替换当前图像",
    "facilities" => "便利设施",
    "please_select_facilities" => "选择便利设施",
    "landmarks" => "附近地标",
    "please_select_landmark" => "-- 选择地标 --",
    "distance_km" => "距离 (公里)",
    "add_landmark" => "添加地标",
    "images_and_video" => "图片和视频",
    "bedroom_images" => "卧室图片",
    "bathroom_images" => "浴室图片",
    "other_images" => "其他图片",
    "plan_images" => "平面图",
    "video" => "宣传视频",
    "current_video" => "当前视频 (上传新文件以替换)",
    "status" => "状态",
    "status_available" => "可租",
    "status_full" => "已满",
    "manage_existing_images" => "管理现有图像",
    "cover_image" => "封面图片",
    "set_as_cover" => "设为封面",
    "delete_this_image" => "删除此图像",
    "delete_selected_images" => "删除所选图像",
    "confirm_delete_selected_images" => "您确定要删除所有选定的图像吗？",
    "confirm_delete_this_image" => "您确定要删除此图像吗？",
    "confirm_set_as_cover" => "您确定要将此图像设置为封面吗？",
